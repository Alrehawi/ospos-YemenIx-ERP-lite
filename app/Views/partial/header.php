...
<!doctype html>
<html lang="<?= $request->getLocale() ?>" dir="rtl">

<head>
    <meta charset="utf-8">
    <base href="<?= base_url() ?>">
    <!-- <title><?= esc($config['company']) . ' | ' . lang('Common.powered_by') . ' YEMENIX POS ' . esc(config('App')->application_version) ?></title> -->
     <title><?= esc($config['company']) ?> | YEMENIX POS v1.0</title>
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden-sm" href="<?= site_url() ?>">YEMENIX POS</a>
                </div>
