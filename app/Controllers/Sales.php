...
class Sales extends Secure_Controller
{
    ...
    public function postAdd(): void
    {
        ...
        // $this->sale_lib->recalculate_payments();
    ...
    //    $is_real_sale = !$this->sale_lib->is_quote_mode() 
    //             && !$this->sale_lib->is_work_order_mode();
...
if (!empty($data['sale_id_num']) && $data['sale_id_num'] != NEW_ENTRY)
{
    $accounting = new \App\Libraries\AccountingService();
    ...
    if ($is_real_sale)
    {
        log_message('error', '=== PAYMENTS DEBUG ===');
        log_message('error', json_encode($data['payments']));
