...
$routes->match(['get','post'], 'messages/send', 'Messages::send');
$routes->match(['get','post'], 'messages/send_form/(:num)', 'Messages::send_form/$1');
$routes->get('messages', 'Messages::getIndex');

$routes->get('accounting/ledger/(:num)', 'Accounting::ledger/$1');
$routes->get('accounting/ledger', 'Accounting::ledger');

$routes->get('accounting', 'Accounting::index');
$routes->get('accounting/accounts', 'Accounting::accounts');
$routes->post('accounting/storeAccount', 'Accounting::storeAccount');

$routes->get('accounting/journal', 'Accounting::journal');
$routes->get('accounting/journal/(:num)', 'Accounting::journalDetails/$1');

$routes->get('accounting/ledger', 'Accounting::ledger');

$routes->get('accounting/reports', 'Accounting::reports');
$routes->get('accounting/trial-balance', 'Accounting::trialBalance');
$routes->get('accounting/profit-loss', 'Accounting::profitLoss');

$routes->get('accounting/account/create', 'Accounting::createAccount');
$routes->get('accounting/account/edit/(:num)', 'Accounting::editAccount/$1');
$routes->post('accounting/account/save', 'Accounting::saveAccount');